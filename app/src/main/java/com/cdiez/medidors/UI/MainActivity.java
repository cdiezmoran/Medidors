...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTabLayout.addTab(mTabLayout.newTab().setIcon(R.drawable.ic_information_outline_white_24dp));
        mTabLayout.addTab(mTabLayout.newTab().setIcon(R.drawable.ic_settings_white_24dp));
